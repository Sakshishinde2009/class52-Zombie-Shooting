...
//displaying score,remening lives,bullets
 textSize(20);
 fill("white");
 text("Bullets =  "+ bullets,displayWidth - 210,displayHeight/2 - 300);

 textSize(20);
 fill("white");
 text("Score  =  "+ score,displayWidth - 210,displayHeight/2 - 260);

 textSize(20);
 fill("white");
 text("Lives =  "+ life,displayWidth - 210,displayHeight/2 - 220);
